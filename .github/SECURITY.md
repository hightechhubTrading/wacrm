...
- [GitHub Security Advisories](https://github.com/hightechhubTrading/wacrm/security/advisories/new)
...
In scope:
- Anything in this repository (`hightechhubTrading/wacrm`), including webhook and auth
