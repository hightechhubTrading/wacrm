...
// (the upstream template's docs/marketing site, an unrelated repo).
// Deploys that didn't set `NEXT_PUBLIC_SITE_URL` got invite links
// pointing at a stranger's real site, which 404s on `/join/<token>`.
// This resolution
