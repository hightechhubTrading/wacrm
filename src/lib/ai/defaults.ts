  ...
  if (mode === 'auto_reply' && media && media.length > 0) {
        parts.push(
                'Media library -- product photos / catalog files you may attach to your reply, listed as `[id] name (product label) -- description`. ' +
                  ...
                  'The customer never sees this marker -- it is stripped before sending and the matching file is attached automatically. ' +
                  'If nothing clearly matches, do not attach anything and do not mention the marker.\n\n' +
                  media
                    .map(
                                  (m) =>
